...
You can complete this assignment either using the provided HTML and CSS or use the Relaxr Blog page that you built for the Week 3 assignment.

###Final Project Milestone 1

By Week 5, you should have created and handed in wireframes that sketch out your idea and basic design for a final project.
