 ...
 */
	...
	function question3(){
		$("ol").find("li.falseFact").text("True Fact");
	}
 ...
 */
 ...
 /* Description
 		When button 3 is clicked, the function question 8 gets executed.
		This function looks for the class '.city' and changes the attribute 'source' of the image to the new food image's URL */
 ...
 */
 ...
 function question9(){
  $("p").css({"color":"blue", "font-family":"Georgia"}); /*Spotted the intentional(?) mistake of missing "" on the attributes*/
 }
